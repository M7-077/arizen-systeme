...
const devs = ['487310147798958082'];
const db = require('quick.db');
const premium = ['487310147798958082']
...
${prefix}abc / رسالة جماعية الى كل اعضاء السيرفر
...
const prefix = "$";
const token = "NTkxOTMyNDkwMzY5NzI4NTMz.XQ3-HQ.LAOYxdLzAjA_3Db9MkFvsf9Yu5Q";
...
if (message.content.toLowerCase().startsWith(prefix + `new`)) {
    ...
    message.guild.createChannel(`ticket-${message.author.id}`, "text").then(c => {
        ...
        const embed = new Discord.RichEmbed()
        .setColor(0xCF40FA)
        .addField(`Hey ${message.author.username}!`, ` Mo7aMeD Bot انتضر احد اشخاص من ادارة لكي يفحصك و من فضلك لا تمنشن مشان لا تتصفر.`)
        .setTimestamp();
        c.send({ embed: embed });
    }).catch(console.error);
}
...
const devid = ["487310147798958082"]//غيرها الي ايديهات مبرمجين البوت
